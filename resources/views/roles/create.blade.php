                    ...
                    <div class="mx-auto w-full max-w-[550px]">
                        <form action="{{ route('roles.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mt-4">
                                ...
                                <input id="role" class="block mt-1 w-full" type="text" name="role" placeholder="Ingrese el nombre del rol" required autofocus />
                            </div>
                            <div class="form-check mt-4">
                                @foreach ($permissions as $permission)
                                    <div>
                                        <input class="form-check-input" type="checkbox" id="name" name="permissions[]" value="{{$permission->id}}">
