    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="text-end pb-2">
                @can('domas.create')
                    <a href="{{ route('domas.create')}}" class="btn btn-success" style="background-color: #11C163; border: none;">
                                ...
                                @can('domas.edit')
                                    <td class="">
                                        <div class="flex justify-end">
                                            @can('domas.edit')
                                                <a href="{{ route('domas.edit', $doma->id)}}" class="btn btn-dark btn-sm mx-1" style="background-color: #FF9218; border: none;"><svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                                            ...
                                            @endcan
                                            @can('domas.destroy')
                                                <form action="{{ route('domas.destroy', $doma->id)}}" class="formEliminar" method="POST">
                                                    @csrf
                                                    @method('DELETE')
    ...
    (function () {
        ...
        .forEach(function (form) {
            form.addEventListener('submit', function (event) {        
                ...
                Swal.fire({
                    title: 'Se borrará esta doma y todos los caballos que la tengan asignada. ¿Estás seguro?',
                    icon: 'info',
