                    ...
                    <div class="mx-auto w-full max-w-[550px]">
                        <form action="{{ route('herrajes.update', $herraje->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nombre" id="nombre" value="{{$herraje->nombre}}" required class="w-full rounded-md border border-[#e0e0e0] bg-white py-2 px-2 text-base font-medium text-[#6B7280] outline-none focus:border-[#6A64F1] focus:shadow-md">
                            </div>
