    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="text-end pb-2">
                <a href="{{ route('vacunas.create')}}" class="btn btn-success" style="background-color: #11C163; border: none;">Crear una vacuna</a>
            </div>
            @if(session('message'))
    ...
    (function () {
        ...
        .forEach(function (form) {
            form.addEventListener('submit', function (event) {        
                ...
                Swal.fire({
                    title: '¿Seguro que quiere eliminar esta vacuna?',
                    icon: 'info',
